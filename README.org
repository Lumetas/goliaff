...
* Best Practices
  ...
  2. **Version control your config**: Store goliaff.json in Git
...
* Troubleshooting
  ...
  *** "Invalid JSON or unable to read goliaff.json"
      #+BEGIN_SRC bash
      # Validate JSON syntax
      python3 -m json.tool goliaff.json
...
#+BEGIN_SRC json
	...
	"plugins": [
		"sudo ./plugins/d-conf/ssh",
		"./plugins/d-conf/custom"
	]
#+END_SRC
with stages:
#+BEGIN_SRC json
...
A plugin is any executable program. Goliaff passes her the config to stdin at startup.
